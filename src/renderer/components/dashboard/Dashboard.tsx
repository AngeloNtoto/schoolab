...
export default function Dashboard() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-50/50 dark:bg-[#020617] relative transition-colors duration-500">
      <div 
        ...
        <div className="max-w-7xl mx-auto px-2 py-5">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-[2rem] p-5 transition-all hover:bg-white/15 hover:scale-[1.02] duration-300">
                <div className="flex items-center gap-4">
                  <div className="bg-white/20 dark:bg-blue-500/20 p-3 rounded-2xl text-white dark:text-blue-400 shadow-lg">
                    <Users size={22} />
                  </div>
                  <div>
                    <p className="text-2xl font-black text-white tracking-tighter">{totalStudents}</p>
                    <p className="text-[9px] text-blue-100 dark:text-slate-500 font-black uppercase tracking-[0.15em]">Élèves</p>
                  </div>
                </div>
              </div>
              <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-[2rem] p-5 transition-all hover:bg-white/15 hover:scale-[1.02] duration-300">
                <div className="flex items-center gap-4">
                  <div className="bg-white/20 dark:bg-indigo-500/20 p-3 rounded-2xl text-white dark:text-indigo-400 shadow-lg">
                    <GraduationCap size={22} />
                  </div>
                  <div>
                    <p className="text-2xl font-black text-white tracking-tighter">{classes.length}</p>
                    <p className="text-[9px] text-blue-100 dark:text-slate-500 font-black uppercase tracking-[0.15em]">Classes</p>
                  </div>
                </div>
              </div>
              <div className="hidden md:block bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-[2rem] p-5 transition-all hover:bg-white/15 hover:scale-[1.02] duration-300">
                <div className="flex items-center gap-4">
                  <div className="bg-white/20 dark:bg-purple-500/20 p-3 rounded-2xl text-white dark:text-purple-400 shadow-lg">
                    <Layers size={22} />
                  </div>
                  <div>
                    <p className="text-2xl font-black text-white tracking-tighter">{[...new Set(classes.map(c => c.option))].length}</p>
                    <p className="text-[9px] text-blue-100 dark:text-slate-500 font-black uppercase tracking-[0.15em]">Options</p>
                  </div>
                </div>
              </div>
              <div className="hidden md:block bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-[2rem] p-5 transition-all hover:bg-white/15 hover:scale-[1.02] duration-300">
                <div className="flex items-center gap-4">
                  <div className="bg-white/20 dark:bg-emerald-500/20 p-3 rounded-2xl text-white dark:text-emerald-400 shadow-lg">
                    <ArrowUpDown size={22} />
                  </div>
                  <div>
                    <p className="text-2xl font-black text-white tracking-tighter">{[...new Set(classes.map(c => c.level))].length}</p>
                    <p className="text-[9px] text-blue-100 dark:text-slate-500 font-black uppercase tracking-[0.15em]">Niveaux</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              <div className="relative w-full sm:w-96 group">
                ...
                <input 
                  ...
                  className="w-full pl-14 pr-6 py-4 bg-white/10 dark:bg-black/20 border border-white/10 dark:border-white/5 rounded-[2rem] text-white placeholder-white/40 focus:ring-4 focus:ring-white/10 focus:bg-white/20 dark:focus:bg-black/40 transition-all outline-none font-bold text-sm shadow-inner"
                />
              </div>
