...
export default function TopNavigation() {
  ...
  return (
    <div className="h-16 bg-white dark:bg-slate-900 border-b-2 border-slate-300 dark:border-slate-700 flex items-center justify-between px-6 sticky top-0 z-20 shadow-md">
        ...
        <div className="relative w-96 hidden md:block group z-50">
            <div className={`flex items-center bg-slate-100 dark:bg-slate-800 rounded-lg px-3 py-2 border transition-colors ${isSearchOpen ? 'border-blue-500 ring-2 ring-blue-500/20' : 'border-transparent'}`}>
