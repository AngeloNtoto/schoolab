  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-50/50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-12">
        ...
        {showForm && (
          <div className="bg-white dark:bg-slate-900/50 backdrop-blur-xl p-8 rounded-[2rem] shadow-2xl border border-slate-200 dark:border-white/5 mb-10 animate-in fade-in slide-in-from-top-4 duration-500">
