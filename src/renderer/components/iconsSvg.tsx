...
const createIcon = (name: string, nodes: any[]) => {
  const Icon = React.forwardRef<SVGSVGElement, IconProps>(
    ({ color = "currentColor", size = 24, strokeWidth = 2, className, children, ...rest }, ref) => {
      return (
        <svg
          ref={ref}
        ...
        >
          {nodes.map((node, index) => {
              ...
              return React.createElement(tag, { ...attrs, key: attrs.key || index });
          })}
          {children}
        </svg>
      );
...
export const ChevronDown = createIcon("ChevronDown", [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]]);
export const ChevronLeft = createIcon("ChevronLeft", [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]]);
export const ChevronRight = createIcon("ChevronRight", [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]]);
export const ChevronUp = createIcon("ChevronUp", [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]]);
...
export const Loader2 = createIcon("Loader2", [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }]]);
...
export const ArrowRight = createIcon("ArrowRight", [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
  ["path", { d: "m12 5 7 7-7 7", key: "1ays0i" }]
]);
export const Phone = createIcon("Phone", [
  ["path", { d: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.05 12.05 0 0 0 .57 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.03 12.03 0 0 0 2.81.57 2 2 0 0 1 1.72 2z", key: "phone" }]
]);
export const Mail = createIcon("Mail", [
  ["rect", { width: "20", height: "16", x: "2", y: "4", rx: "2", key: "mail1" }],
  ["path", { d: "m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7", key: "mail2" }]
]);
export const Rocket = createIcon("Rocket", [
  ["path", { d: "M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z", key: "rocket1" }],
  ["path", { d: "m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z", key: "rocket2" }],
