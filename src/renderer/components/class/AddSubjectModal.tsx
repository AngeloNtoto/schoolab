                        ...
                        {!showDomainCreate ? (
                            <div className="flex gap-3">
                                <select
                                    ...
                                    className="flex-1 px-6 py-4 bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-white/5 rounded-2xl text-slate-900 dark:text-white font-bold focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all shadow-inner appearance-none"
                                >
                                ...
                                <button
                                    ...
                                    className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 text-blue-600 dark:text-blue-400 rounded-2xl hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all shadow-sm active:scale-95"
                                >
                                    <Plus size={20} />
                                </button>
                            </div>
                        ) : (
                            <div className="space-y-3 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-2xl border border-slate-200 dark:border-white/5 animate-in fade-in slide-in-from-top-2">
                                <input
                                    type="text"
                                    value={newDomainName}
                                    onChange={(e) => setNewDomainName(e.target.value)}
                                    className="w-full px-4 py-3 bg-white dark:bg-slate-950 border border-slate-200 dark:border-white/5 rounded-xl text-slate-900 dark:text-white font-bold outline-none"
