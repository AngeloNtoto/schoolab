              ...
              >
                  <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl shrink-0">
                      <button 
                        ...
                        className={`flex-1 py-1.5 rounded-lg text-[9px] font-bold transition-all ${activeConfigSection === 'options' ? 'bg-white dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                          Options
                      </button>
                      <button 
                        onClick={() => setActiveConfigSection('domains')}
                        className={`flex-1 py-1.5 rounded-lg text-[9px] font-bold transition-all ${activeConfigSection === 'domains' ? 'bg-white dark:bg-slate-700 shadow-sm text-slate-900 dark:text-white' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                          Domaines
                      </button>
                  </div>
                  ...
                  {activeConfigSection === 'options' ? (
                       <div className="flex-1 flex flex-col space-y-4 overflow-hidden">
                           <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-xl flex items-start gap-3 shrink-0">
                              <GraduationCap className="text-blue-600 shrink-0 mt-0.5" size={16} />
                              <p className="text-[10px] font-bold text-blue-700 dark:text-blue-300/80 leading-relaxed">
                                Définissez les orientations (ex: Bio-Chimie). La suppression n'affecte pas les classes déjà créées.
                              </p>
                           </div>
                       ...
                       <div className="flex-1 flex flex-col space-y-4 overflow-hidden">
                            <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-xl flex items-start gap-3 shrink-0">
                                ...
                                <p className="text-[10px] font-bold text-purple-700 dark:text-purple-300/80 leading-relaxed">
                                    Les domaines regroupent les cours sur les bulletins. Partagés entre toutes les classes.
                                </p>
                            </div>
