    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <Activity mode={editModal || bulletinModal || bulkPrintModal || couponsModal || palmaresModal ? "hidden" : "visible"}>
                <motion.div 
                    animate={{ 
                        opacity: (editModal || bulletinModal || bulkPrintModal || couponsModal || palmaresModal) ? 0.3 : 1,
                        scale: (editModal || bulletinModal || bulkPrintModal || couponsModal || palmaresModal) ? 0.98 : 1,
                        filter: (editModal || bulletinModal || bulkPrintModal || couponsModal || palmaresModal) ? "blur(4px)" : "blur(0px)"
                    }}
