  ...
  return (
    <div className="flex h-full bg-slate-50/50 dark:bg-slate-950 transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-blue-600 dark:bg-slate-900/50 border-b border-transparent dark:border-white/5 px-8 py-10 shadow-lg transition-colors backdrop-blur-xl">
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-white/20 dark:bg-blue-600/30 rounded-2xl shadow-xl backdrop-blur-md transition-colors">
                  <StickyNote className="text-white dark:text-blue-400" size={28} />
                </div>
                <div>
                  <h1 className="text-3xl font-black text-white dark:text-white tracking-tight">Notes & Mémos</h1>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-slate-50/50 dark:bg-transparent transition-colors">
            {loading ? (
              <div className="py-20 flex flex-col items-center justify-center">
                <ProfessionalLoader message="Chargement des mémos..." subMessage="Veuillez patienter" />
              </div>
