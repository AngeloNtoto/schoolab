...
ADD COLUMN created_at TEXT DEFAULT '1970-01-01 00:00:00';
ALTER TABLE subjects
ADD COLUMN updated_at TEXT DEFAULT '1970-01-01 00:00:00';
...
ALTER TABLE subjects
ADD COLUMN domain_id INTEGER REFERENCES domains(id) ON DELETE
SET NULL;
-- Insert default domains for primary school (7ème and 8ème)
INSERT
  OR IGNORE INTO domains (name, display_order)
VALUES ('Domaine des Langues', 1),
  (
